...
public interface IItem
{
    ...
    /// <seealso cref="Item.Recolor(Color,System.Nullable{Color},double)"/>
    ...
    IItem AddCurve(Mat curvePoints,
        bool addToRef = false,
    ...
    void SetSpeed(double speedLinear,
    ...
    void AddCustomInstruction(string name,
        string pathRun,
        string pathIcon = "",
        bool blocking = true,
